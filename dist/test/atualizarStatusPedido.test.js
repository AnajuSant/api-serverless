...
const atualizarStatusPedido_1 = require("../atualizarStatusPedido");
// Mock do DynamoDB
const mockDynamoDb = {
...
describe('atualizarStatusPedido', () => {
    it('deve atualizar o status do pedido com sucesso', async () => {
        ...
        const callback = () => { };
        const response = (await (0, atualizarStatusPedido_1.atualizarStatusPedido)(event, context, callback));
